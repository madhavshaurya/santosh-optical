    ...
    <div class="container">
      <div class="row pb-100 bord-thin-bottom mb-80">
        ...
        <div class="col-lg-7 offset-lg-1">
          <div>
            <h3 class="text-u text-indent">Our experience in vision, delivering clarity, comfort and confidence through expert care.</h3>
            <div class="text mt-30">
              <p>Our approach combines modern diagnostic tools with an exclusive selection of eyewear, ensuring that every
      experience at Santosh Optical is both precise and fashion-forward.
              </p>
            </div>
          </div>
        </div>
