        ...
        <div class="col-lg-10">
          <div class="caption">
            <div class="sub-title fz-12">
              <a href="#0"><span>Eye Care</span></a>
            </div>
            <h1 class="fz-55 mt-30">How Regular Eye Checkups Improve Long-Term Vision Health.</h1>
          </div>
              ...
              <div class="d-flex">
                <div class="author-info">
                  <div class="d-flex align-items-center">
                    ...
                    <a href="#0" class="ml-20">
                      ...
                      <h6 class="fz-16">Kshityiz Sharma</h6>
                    </a>
                  </div>
                </div>
                ...
                <div class="date ml-50">
                  <a href="#0">
                    ...
                    <h6 class="fz-16">November 12, 2025</h6>
                  </a>
                </div>
              </div>
            </div>
